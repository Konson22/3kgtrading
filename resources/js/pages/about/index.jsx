            ...
            <section className="container-px mx-auto max-w-5xl px-5 py-8 lg:py-20">
                ...
                <div className="prose prose-lg max-w-none text-gray-600">
                    <p className="mb-6 leading-relaxed">
                        3K General Trading Co. Ltd is a multiservice provider
                    ...
                    <p className="leading-relaxed">
                        Since its establishment, 3K General Trading Co. Ltd has
            ...
            <section className="px-5 py-20">
                <div className="container-px mx-auto max-w-5xl">
                    ...
                    <p className="mb-12 max-w-3xl leading-relaxed text-gray-600">
                        3K General Trading Co. Ltd provides safe, reliable,
