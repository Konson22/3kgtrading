...
export default function ContactPage() {
                ...
                <section className="container-px mx-auto max-w-xl py-16 text-center sm:py-20">
                    <div className="rounded-2xl border border-secondary/20 bg-secondary/5 px-6 py-10 sm:px-10">
                        ...
                        <p className="text-sm text-gray-600">
                            We will respond to <strong>{formData.email}</strong>{' '}
    ...
    return (
        <div className="bg-white">
            ...
            >
                <p>
                    Reach out to 3K General Trading Ltd for quality services and
                    products.
                </p>
            </PageSecondaryHero>

            <div className="container-px mx-auto max-w-5xl bg-white px-4 py-16 sm:px-6 sm:py-20">
                <div className="">
                    ...
                    <div
                        className="mt-3 h-1 w-16 rounded-full bg-secondary"
                        aria-hidden
                    />
                </div>
                ...
                <div className="grid gap-12 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="mt-3 text-sm text-gray-600 sm:text-base">
                                Visit our office in Juba or reach out using the
                                phone numbers, email address, or website below.
                            </p>
                        </div>
                    ...
                    <div className="lg:self-center">
                        <div className="rounded-2xl border border-gray-100 bg-gray-50/50 p-6 sm:p-7 lg:p-8">
                            ...
                            <ul className="space-y-4">
                                {contact.phones.map((phone) => {
                                    ...
                                    const label = phone.replace('+211 (0) ', '+211 ');
                                    return (
                                    <li key={phone}>
                                        <a
                                            href={`tel:${tel}`}
                                            onClick={() => trackPhoneClick('contact_page')}
                                            className="flex items-center gap-3 text-gray-600 transition-colors hover:text-primary min-h-[44px]"
                                        >
                ...
                <div className="mt-16 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                    <div className="px-4 pt-6 sm:px-6 sm:pt-8">
                        <h3 className="mb-2 text-sm font-semibold tracking-wide text-gray-500 uppercase">
                            Map & directions
                        </h3>
                        <p className="mb-4 text-sm text-gray-600">
                            Find our Juba office on the map and get driving or
                            walking directions.
                        </p>
                    </div>
                    <div className="h-72 w-full sm:h-96">
                        <iframe
                            title="3K General Trading Ltd office location"
                            src="https://www.google.com/maps?q=4.8538566,31.5825254&z=17&output=embed"
                            className="h-full w-full border-0"
                            loading="lazy"
                            referrerPolicy="no-referrer-when-downgrade"
                        />
                    </div>
                    <div className="px-4 pt-3 pb-6 text-right sm:px-6">
                        <a
                            href="https://www.google.com/maps/place/3K+General+Trading+Co.Ltd/@4.8538619,31.5799505,17z/data=!3m1!4b1!4m6!3m5!1s0x17128155a42810bd:0x2efd9879c317c39c!8m2!3d4.8538566!4d31.5825254!16s%2Fg%2F11wr3llvl8?hl=en-US"
                            target="_blank"
                            rel="noopener noreferrer"
